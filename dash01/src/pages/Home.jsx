    ...
    <div className="flex flex-col min-h-screen w-full bg-teal-50">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between w-full bg-gradient-to-r from-teal-100 to-teal-200 py-20 px-8 md:px-16">
        <div className="flex-1 flex flex-col space-y-6 text-left md:text-left">
          <h1 className="text-5xl md:text-6xl font-poopins text-teal-900 leading-tight">
...
<section className="w-full px-8 md:px-16 py-16 bg-white text-center">
  <h2 className="text-3xl md:text-4xl font-bold mb-12 text-teal-900">
    What People Say
  </h2>
  <div className="flex flex-wrap justify-center gap-8">
  ...
  <section className="bg-gradient-to-b from-white to-gray-50 py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Inspired by <span className="font-semibold text-indigo-600">Katalyst</span>, our journey began with a mission 
          to empower and uplift individuals through education, innovation, and mentorship. 
          What started as a small initiative grew into a thriving community of changemakers 
          who believe in breaking barriers and building opportunities.
        </p>
      </div>
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-left">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Just like Katalyst, we started by creating a strong foundation for growth. 
            We focused on nurturing talent, fostering leadership, and providing access 
            to the right resources. Over the years, our impact has expanded, creating 
            a ripple effect of change in communities.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Today, we are proud to carry forward this vision, supporting a network of 
            innovators and leaders who are shaping the future. Our story is a reflection 
            of resilience, collaboration, and a shared dream to create meaningful change.
          </p>
        </div>
      </div>
    </section>
